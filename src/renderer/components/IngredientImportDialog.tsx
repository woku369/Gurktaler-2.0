...
import type { ImportResult } from "@/renderer/services/ingredientImport";
import {
  parseExcelFile,
  validateIngredients,
  convertToIngredient,
...
export default function IngredientImportDialog({
  isOpen,
  onClose,
  onImportComplete,
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Standardmäßig alle gültigen auswählen
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gurktaler-50 border-vintage border-gurktaler-200 rounded-vintage p-4">
                ...
                <ul className="text-sm text-distillery-700 font-body space-y-1 list-disc list-inside">
                  ...
                  <li>Alkoholgehalt muss zwischen 0 und 100% liegen</li>
                  <li>Kosten und Lagerbestand dürfen nicht negativ sein</li>
                  <li>
            ...
            <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-heading font-semibold text-distillery-900">
                      Gültige Zutaten ({selectedValid.size}/
                  ...
                  <div className="space-y-2 max-h-64 overflow-y-auto">
                    {importResult.valid.map((ing, index) => (
                      <label
                        key={index}
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-distillery-600 font-body">
                            {[
                              ing.category,
                              ing.alcohol_percentage !== undefined &&
                                `${ing.alcohol_percentage}% vol.`,
                              ing.supplier,
                            ]
                              .filter(Boolean)
                              .join(" • ")}
              ...
              {importResult.duplicates.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {importResult.duplicates.map((ing, index) => (
                      <div
                        key={index}
              ...
              {importResult.invalid.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {importResult.invalid.map((ing, index) => (
                      <div
                        key={index}
