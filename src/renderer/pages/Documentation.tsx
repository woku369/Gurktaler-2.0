...
const sections: Section[] = [
  ...
  },
  {
    ...
    content: {
      ...
      tips: [
        "🔐 Backup-Strategie: Git-Integration ist dein automatisches Backup-System",
        "📦 Jede Datenänderung → Auto-Commit → Auto-Push → Sicher auf GitHub",
        "🔄 Auto-Pull beim Start = Immer aktuellste Daten + Konfliktlösung",
        "☁️ Remote-Repository (privat!) = Deine Cloud-Backup-Lösung",
        "💾 Zusätzlich: JSON-Export als lokales Backup vor kritischen Aktionen",
        "⚠️ Bei Konflikten: Remote übernehmen ist meist die richtige Wahl",
