    ...
    content: {
      ...
      howTo: [
        ...
        },
        {
          ...
          steps: [
            "Option 1 - In der App (NEU in v1.7.3):",
            "   Einstellungen öffnen → PWA API Server Section",
            "   Button 'Server-Logs anzeigen' klicken",
            "   Letzte 50 Zeilen werden live angezeigt",
            "   Farbcodierung: Rot=Fehler, Gelb=Warnung, Grün=Erfolg",
            "   Button 'Aktualisieren' für neue Logs",
            "",
            "Option 2 - SSH zum NAS:",
        ...
        {
          title: "Health-Metriken anzeigen (NEU)",
          steps: [
            "Einstellungen → PWA API Server",
            "Bei 'Server läuft einwandfrei' werden angezeigt:",
            "   Memory (Used): Aktuell genutzter Speicher",
            "   Memory (Total): Gesamter verfügbarer Heap",
            "   PID: Prozess-ID des Servers",
            "   Node Version: Node.js Version (z.B. v18.x)",
            "API-Endpoint: GET /api/health",
            "Automatische Prüfung beim Status-Check",
          ],
        },
      ],
      tips: [
        ...
        "🌐 Endpoints: /api/json, /api/logs, /api/health",
        ...
        "📊 Health-Metriken: Memory, Uptime, PID, Node-Version in Echtzeit",
        "📋 Log-Viewer: Farbcodierte Anzeige direkt in der App (v1.7.3)",
      ],
    },
  },
  {
    ...
    content: {
      description:
        "Vollständiges Event-Management für Google Calendar direkt aus der App. Erstelle, bearbeite und lösche Calendar-Events. TODOs mit Fälligkeitsdatum werden automatisch synchronisiert. Alle Änderungen in der App werden zu Google gepusht. Funktioniert über OAuth 2.0 - keine Passwortspeicherung.",
      howTo: [
        {
          title: "1. Google Cloud Projekt erstellen",
          steps: [
            "Google Cloud Console öffnen: https://console.cloud.google.com",
            "Neues Projekt erstellen: 'Gurktaler TODO Sync'",
            "Projekt auswählen (oben links im Dropdown)",
            "",
            "APIs aktivieren:",
            "   → APIs & Services → Library",
            "   → 'Google Calendar API' suchen und aktivieren",
            "   → Button 'Aktivieren' klicken",
          ],
        },
        {
          title: "2. OAuth 2.0 Client-ID erstellen",
          steps: [
            "APIs & Services → Anmeldedaten (Credentials)",
            "Button '+ ANMELDEDATEN ERSTELLEN' → OAuth-Client-ID",
            "",
            "Falls Zustimmungsbildschirm fehlt:",
            "   → OAuth-Zustimmungsbildschirm konfigurieren",
            "   → Extern wählen (für persönliche Nutzung)",
            "   → App-Name: 'Gurktaler TODO Sync'",
            "   → Support-E-Mail: Deine E-Mail",
            "   → Speichern",
            "",
            "OAuth-Client-ID erstellen:",
            "   Anwendungstyp: 'Webanwendung'",
            "   Name: 'Gurktaler Web Client'",
            "   Autorisierte JavaScript-Ursprünge hinzufügen:",
            "      http://localhost:3000",
            "      http://100.121.103.107",
            "   Autorisierte Weiterleitungs-URIs: (leer lassen)",
            "   Button 'Erstellen'",
            "",
            "✅ Deine Client-ID:",
            "   168621561394-n23e4uqa9vcqpmuism61r1pbjra6shde.apps.googleusercontent.com",
          ],
        },
        {
          title: "3. API-Schlüssel erstellen",
          steps: [
            "APIs & Services → Anmeldedaten",
            "Button '+ ANMELDEDATEN ERSTELLEN' → API-Schlüssel",
            "API-Schlüssel kopieren (Format: AIzaSy...)",
            "",
            "WICHTIG - API-Schlüssel einschränken:",
            "   → Button 'Schlüssel einschränken' bei dem neuen Key",
            "   → API-Einschränkungen → 'Schlüssel einschränken'",
            "   → 'Google Calendar API' auswählen",
            "   → Speichern",
            "",
            "✅ Dein API-Key:",
            "   AIzaSyCzW0HUn6snPuZVPTAiBlaq4N1_sWxPEWg",
          ],
        },
        {
          title: "4. Credentials in der App konfigurieren",
          steps: [
            "Gurktaler App öffnen",
            "Einstellungen → Google Calendar Integration",
            "Client-ID eintragen:",
            "   168621561394-n23e4uqa9vcqpmuism61r1pbjra6shde.apps.googleusercontent.com",
            "API-Schlüssel eintragen:",
            "   AIzaSyCzW0HUn6snPuZVPTAiBlaq4N1_sWxPEWg",
            "Button 'Credentials speichern'",
            "✅ Status sollte 'OAuth-Credentials konfiguriert' anzeigen",
            "",
            "Alternativ: .env Datei im Projekt-Root:",
            "   VITE_GOOGLE_CLIENT_ID=168621561394-n23e4uqa9vcqpmuism61r1pbjra6shde.apps.googleusercontent.com",
            "   VITE_GOOGLE_API_KEY=AIzaSyCzW0HUn6snPuZVPTAiBlaq4N1_sWxPEWg",
            "   npm run dev neu starten",
          ],
        },
        {
          title: "5. Bei Google anmelden",
          steps: [
            "Dashboard öffnen",
            "Google Calendar Widget (unten rechts)",
            "Button 'Bei Google anmelden' klicken",
            "Google Account auswählen",
            "Berechtigungen bestätigen:",
            "   ✓ Google Calendar Events ansehen",
            "   ✓ Google Calendar Events erstellen/bearbeiten/löschen",
            "Nach erfolgreichem Login: Widget zeigt Kalender mit Events",
          ],
        },
        {
          title: "6. Events verwalten (CRUD-Operationen)",
          steps: [
            "Dashboard → Kalender-Widget",
            "Klick auf beliebigen Tag im Kalender",
            "→ DateTasksModal öffnet sich",
            "",
            "📅 Neues Event erstellen:",
            "   • Button 'Neuer Termin' klicken",
            "   • Formular ausfüllen:",
            "     - Titel (Pflichtfeld)",
            "     - Beschreibung (optional)",
            "     - Ganztägig-Checkbox",
            "     - Start-/Endzeit (falls nicht ganztägig)",
            "   • Button 'Erstellen' → Event erscheint in Google Calendar",
            "",
            "✏️ Event bearbeiten:",
            "   • Klick auf Event-Card (lila)",
            "   • Edit-Button klicken",
            "   • Formular wird vorausgefüllt",
            "   • Änderungen vornehmen",
            "   • Button 'Aktualisieren' → Event wird in Google aktualisiert",
            "",
            "🗑️ Event löschen:",
            "   • Klick auf Trash-Button bei Event",
            "   • Bestätigungsdialog: Ja",
            "   • Event wird aus Google Calendar entfernt",
            "",
            "✅ TODO-Sync (automatisch):",
            "   • TODO mit Fälligkeitsdatum erstellen",
            "   • Button 'Mit Google Calendar synchronisieren'",
            "   • Alle TODOs mit Datum werden als Events erstellt",
          ],
        },
        {
          ...
          steps: [
            ...
            "   → API-Schlüssel in Google Cloud Console überprüfen",
            "   → Sicherstellen dass 'Google Calendar API' aktiviert ist",
            "   → API-Schlüssel auf 'Google Calendar API' eingeschränkt",
            "",
            "❌ 'Invalid client' Fehler:",
            "   → Client-ID korrekt kopiert?",
            "   → JavaScript-Ursprünge korrekt konfiguriert?",
            "   → http://localhost:3000 und http://100.121.103.107",
            "",
            "❌ 'Access denied' beim Login:",
            "   → OAuth-Zustimmungsbildschirm vollständig konfiguriert?",
            "   → App-Status ist 'In Produktion' oder 'Testen'?",
            "   → Bei 'Testen': Testnutzer hinzufügen (deine E-Mail)",
            "",
            "❌ Kalender-Widget zeigt keine Events:",
            "   → Bei Google angemeldet? (Button zeigt 'Verbunden')",
            "   → Hard Refresh: Ctrl+Shift+R",
            "   → Browser Console öffnen (F12) und Fehler prüfen",
            "   → Ausloggen und neu einloggen",
            "",
            "❌ 'Neuer Termin' Button nicht sichtbar:",
            "   → Auf beliebigen Tag im Kalender klicken",
            "   → Modal sollte sich öffnen mit Button oben rechts",
            "   → Falls leer: 'Keine Termine' + Hinweis erscheint",
            "",
      ...
      tips: [
        "☁️ Credentials werden nur lokal gespeichert (LocalStorage)",
        "🔒 OAuth 2.0: Kein Passwort-Speicherung, nur Access-Token",
        "🔄 Bidirektionale Sync: App → Google (nicht Google → App)",
        "📅 TODOs mit Fälligkeitsdatum werden automatisch synchronisiert",
        "🆕 Neue Events: Beliebige Termine direkt aus der App erstellen",
        "✏️ Event-Bearbeitung: Click → Edit → Formular vorausgefüllt",
        "🗑️ Event-Löschen: Trash-Button mit Bestätigungsdialog",
        "🕐 Zeitbereich: 6 Monate zurück + 6 Monate voraus sichtbar",
        "📌 Kalender-Click: Jeder Tag im aktuellen Monat ist klickbar",
        "🎨 Color-Coding: TODOs nach Priorität, Google Events lila",
        "✅ Events haben Prefix '[Gurktaler]' bei TODO-Sync",
        "🔗 Event-Beschreibung enthält TODO-Details bei Sync",
        "🚫 Manuelle Änderungen in Google Calendar werden NICHT zurückgespielt",
        "💾 Credentials in LocalStorage haben Vorrang vor .env",
        "🌐 Desktop-App und PWA nutzen getrennte Credentials",
        "📱 PWA: Credentials müssen pro Browser/Gerät neu eingegeben werden",
        "🔧 .env.example im Projekt zeigt Konfig-Format",
        "🗑️ Button 'Löschen' entfernt nur lokale Credentials, nicht Google-Projekt",
      ],
    },
  },
];
