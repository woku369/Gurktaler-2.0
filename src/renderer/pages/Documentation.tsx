...
const sections: Section[] = [
  ...
  },
  {
    ...
    description: "TODOs automatisch mit Google Calendar synchronisieren",
    content: {
      overview: [
        "Die App kann TODOs automatisch mit Google Calendar synchronisieren",
        "Nur TODOs mit Fälligkeitsdatum werden als Calendar-Events erstellt",
        "Änderungen in der App werden automatisch zu Google gepusht",
        "Löschen in der App löscht auch den Calendar-Event",
        "Funktioniert über OAuth 2.0 - keine Passwortspeicherung",
      ],
      howTo: [
        {
        ...
        },
        {
          ...
          steps: [
            ...
            "   Button 'Erstellen'",
            "",
            "Client-ID kopieren (Format: xxx.apps.googleusercontent.com)",
          ],
        },
        {
        ...
        },
        {
          ...
          steps: [
            ...
            "Client-ID eintragen (xxx.apps.googleusercontent.com)",
            "API-Schlüssel eintragen (AIzaSy...)",
        ...
        },
        {
          ...
          steps: [
            "Dashboard öffnen",
            "Button 'Bei Google anmelden' klicken (unten rechts)",
            "Google Account auswählen",
            "Berechtigungen bestätigen:",
            "   ✓ Google Calendar Events ansehen",
            "   ✓ Google Calendar Events erstellen/bearbeiten",
            "Nach erfolgreichem Login: Button zeigt Google-Account",
          ],
        },
        {
          title: "6. TODOs synchronisieren",
          steps: [
            "Dashboard → TODO mit Fälligkeitsdatum erstellen",
            "Button 'Mit Google Calendar synchronisieren' klicken",
            "Sync läuft automatisch für alle TODOs mit Datum",
            "Google Calendar öffnen → Events sollten sichtbar sein",
            "",
            "Automatische Synchronisation:",
            "   • TODO erstellt → Event wird zu Google Calendar hinzugefügt",
            "   • TODO geändert → Event wird in Google Calendar aktualisiert",
            "   • TODO gelöscht → Event wird aus Google Calendar entfernt",
        ...
        },
        {
          ...
          steps: [
            ...
            "   → http://localhost:5173 und http://100.121.103.107",
            "",
            ...
            "   → Bei Google angemeldet? (Button zeigt Account)",
            "   → TODO hat Fälligkeitsdatum?",
      ...
      tips: [
        ...
        "📅 Nur TODOs mit Fälligkeitsdatum werden synchronisiert",
        "✅ Events haben Prefix '[Gurktaler]' im Titel",
        "🔗 Event-Beschreibung enthält TODO-Details",
