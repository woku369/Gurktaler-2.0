...
export default function Tags() {
  ...
  const handleDelete = (id: string) => {
    if (confirm('Tag löschen? Alle Zuordnungen werden ebenfalls entfernt.')) {
      ...
      assignments.forEach(assignment => tagAssignmentsService.delete(assignment.id))
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Organisieren Sie Projekte, Produkte und Notizen</p>
        </div>
        <button
          onClick={() => setIsFormOpen(true)}
          className="flex items-center gap-2 px-4 py-2 bg-gurktaler-primary text-white rounded-lg hover:bg-gurktaler-dark transition-colors"
        >
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gurktaler-primary focus:border-transparent"
        />
      </div>

      {isFormOpen && (
        <div className="mb-6 p-6 bg-white rounded-lg border-2 border-gurktaler-primary shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gurktaler-primary focus:border-transparent"
            ...
            return (
              ...
              >
                ...
                <div className="text-sm text-gray-600">
                  {usageCount > 0 ? (
                    <div>
                      <div className="font-medium text-gray-700">{usageCount} Verwendungen</div>
